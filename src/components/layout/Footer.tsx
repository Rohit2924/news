        ...
        <div className="md:col-span-2">
          ...
          <div className="flex space-x-4">
            {settings?.facebookUrl && (
              <a href={settings.facebookUrl} className="group bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 p-3 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
                <i className="fab fa-facebook text-white text-lg"></i>
              </a>
            )}
            {settings?.twitterUrl && (
              <a href={settings.twitterUrl} className="group bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 p-3 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
                <i className="fab fa-twitter text-white text-lg"></i>
              </a>
            )}
            {settings?.youtubeUrl && (
              <a href={settings.youtubeUrl} className="group bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 p-3 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
                <i className="fab fa-youtube text-white text-lg"></i>
              </a>
            )}
            {settings?.instagramUrl && (
              <a href={settings.instagramUrl} className="group bg-gradient-to-r from-pink-600 to-pink-700 hover:from-pink-700 hover:to-pink-800 p-3 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
