export default function TermsPage() {
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800 dark:bg-gray-900">
      ...
      {/* Content Section */}
      <section className="container mx-auto py-12 px-6 md:px-12 dark:bg-gray-900">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8 border-2 dark:bg-gray-900">
          <div>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">2. User Responsibilities</h2>
            <p className="text-gray-600 leading-relaxed dark:text-gray-300">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">3. Intellectual Property</h2>
            <p className="text-gray-600 leading-relaxed dark:text-gray-300">
