    ...
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section className="container mx-auto py-12 px-6 md:px-12">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-10">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-3 text-gray-900">Why Advertise With Us</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-3 text-gray-900">Audience Reach</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-3 text-gray-900">Advertising Options</h2>
            <p className="text-gray-600 leading-relaxed">
