  ...
  <div className="hidden md:block space-y-4 p-6">
    {[...Array(5)].map((_, i) => (
      <div key={i} className="flex items-center space-x-4 animate-pulse">
        <div className="w-8 h-8 bg-gray-300 rounded dark:bg-[#262626]"></div>
        <div className="flex-1 space-y-2">
          <div className="h-4 bg-gray-300 rounded w-3/4 dark:bg-[#262626]"></div>
          <div className="h-3 bg-gray-300 rounded w-1/2 dark:bg-[#262626]"></div>
        </div>
        <div className="h-8 bg-gray-300 rounded w-20 dark:bg-[#262626]"></div>
        <div className="h-8 bg-gray-300 rounded w-24 dark:bg-[#262626]"></div>
      </div>
    ))}
  </div>
);
...
const MobileCardSkeleton = () => (
  <div className="md:hidden space-y-4 p-4">
    {[...Array(3)].map((_, i) => (
      <div key={i} className="bg-white border border-gray-200 rounded-lg p-4 animate-pulse dark:bg-[#171717] dark:border-[#262626]">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-3">
            <div className="w-6 h-6 bg-gray-300 rounded dark:bg-[#262626]"></div>
            <div className="space-y-2">
              <div className="h-4 bg-gray-300 rounded w-48 dark:bg-[#262626]"></div>
              <div className="flex gap-2">
                <div className="h-6 bg-gray-300 rounded w-16 dark:bg-[#262626]"></div>
                <div className="h-6 bg-gray-300 rounded w-20 dark:bg-[#262626]"></div>
              </div>
            </div>
          </div>
          <div className="w-6 h-6 bg-gray-300 rounded dark:bg-[#262626]"></div>
...
export default function ArticlesPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'draft':
        return 'bg-yellow-100 text-yellow-800 border border-yellow-200 dark:bg-yellow-500/20 dark:text-yellow-300 dark:border-yellow-500/30';
      case 'published':
        return 'bg-green-100 text-green-800 border border-green-200 dark:bg-green-500/20 dark:text-green-300 dark:border-green-500/30';
      default:
        return 'bg-gray-100 text-gray-800 border border-gray-200 dark:bg-gray-500/20 dark:text-gray-300 dark:border-gray-500/30';
    }
  };

  return (
    <div className="p-6 bg-gray-50 min-h-screen dark:bg-[#0D0D0D]">
      {/* Header */}
          ...
          <div className="flex sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-2 rounded-md border border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 w-full sm:w-48 md:w-64 transition-colors dark:border-[#262626] dark:bg-[#171717] dark:text-white dark:placeholder-gray-400"
              />
            </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-md border text-sm transition-colors ${
                showFilters || hasActiveFilters 
                  ? 'bg-red-100 border-red-300 text-red-700 dark:bg-red-500/20 dark:border-red-500/50 dark:text-red-300 font-bold' 
                  : 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50 dark:bg-[#171717] dark:border-[#262626] dark:text-gray-300 dark:hover:bg-[#262626]'
              }`}
            >
              <Filter size={16} />
              Filters
      ...
      {showFilters && (
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6 dark:bg-[#171717] dark:border-[#262626]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-2 border border-gray-300 rounded-md bg-white text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors dark:border-[#262626] dark:bg-[#171717] dark:text-white"
              >
                <option value="" className="text-gray-400 dark:text-gray-400">All Status</option>
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-2 border border-gray-300 rounded-md bg-white text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors dark:border-[#262626] dark:bg-[#171717] dark:text-white"
              >
                <option value="" className="text-gray-400 dark:text-gray-400">All Categories</option>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 p-2 border border-gray-300 rounded-md bg-white text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors dark:border-[#262626] dark:bg-[#171717] dark:text-white"
                />
              </div>
            </div>
      ...
      {hasActiveFilters && (
        <div className="flex items-center gap-2 mb-4 flex-wrap">
          ...
          {filters.search && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-blue-100 text-blue-800 text-sm rounded-full border border-blue-200 dark:bg-blue-500/20 dark:text-blue-300 dark:border-blue-500/30">
          ...
          {filters.status && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-purple-100 text-purple-800 text-sm rounded-full border border-purple-200 dark:bg-purple-500/20 dark:text-purple-300 dark:border-purple-500/30">
          ...
          {filters.categoryId && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-green-100 text-green-800 text-sm rounded-full border border-green-200 dark:bg-green-500/20 dark:text-green-300 dark:border-green-500/30">
          ...
          {filters.startDate && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-orange-100 text-orange-800 text-sm rounded-full border border-orange-200 dark:bg-orange-500/20 dark:text-orange-300 dark:border-orange-500/30">
          ...
          {filters.endDate && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-pink-100 text-pink-800 text-sm rounded-full border border-pink-200 dark:bg-pink-500/20 dark:text-pink-300 dark:border-pink-500/30">
      ...
      {/* Main Content */}
      <div className="overflow-x-auto bg-white rounded-lg shadow-sm border border-gray-200 dark:bg-[#171717] dark:border-[#262626]">
        {loading ? (
          <>
            <TableSkeleton />
            <MobileCardSkeleton />
          ...
          <>
            ...
            <div className="hidden md:block">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-[#262626]">
                  ...
                  <tr>
                    <th className="px-6 py-3 w-12">
                      <button 
                        ...
                        className="p-1 rounded hover:bg-gray-100 transition-colors dark:hover:bg-[#262626]"
                        title={allSelected ? "Deselect all" : "Select all"}
                      >
                        {allSelected ? (
                          <CheckSquare className="h-4 w-4 text-red-600" />
                        ) : someSelected ? (
                          <div className="w-4 h-4 border-2 border-red-600 bg-red-100 rounded dark:bg-red-500/20" />
                        ) : (
                ...
                <tbody className="bg-white divide-y divide-gray-200 dark:bg-[#171717] dark:divide-[#262626]">
                  {articles.map((article) => (
                    <tr key={article.id} className="hover:bg-gray-50 transition-colors dark:hover:bg-[#262626]/50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="px-2 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 dark:bg-blue-500/20 dark:text-blue-300 border border-blue-200 dark:border-blue-500/30">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <div className="flex gap-2 justify-end">
                          <Link 
                            ...
                            className="p-2 rounded hover:bg-gray-100 text-blue-600 transition-colors dark:hover:bg-[#262626] dark:text-blue-400" 
                            title="View"
                          >
                            <Eye size={18} />
                          </Link>
                          <Link 
                            ...
                            className="p-2 rounded hover:bg-gray-100 text-yellow-600 transition-colors dark:hover:bg-[#262626] dark:text-yellow-400" 
                            title="Edit"
                          >
                            <Edit size={18} />
                          </Link>
                          <button 
                            className="p-2 rounded hover:bg-gray-100 text-red-600 transition-colors dark:hover:bg-[#262626] dark:text-red-400" 
                            title="Delete" 
            ...
            <div className="md:hidden space-y-4 p-4">
              {articles.map((article) => (
                <div key={article.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm transition-colors duration-200 hover:bg-gray-50 dark:bg-[#171717] dark:border-[#262626] dark:hover:bg-[#262626]/50">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <button 
                        onClick={() => toggleSelectRow(article.id)}
                    ...
                    <button 
                      ...
                      className="p-1 rounded hover:bg-gray-100 transition-colors text-gray-400 dark:hover:bg-[#262626]"
                    >
                  ...
                  {expandedRows[article.id] && (
                    <div className="border-t border-gray-200 pt-3 mt-3 space-y-2 dark:border-[#262626]">
            ...
            <div className="flex justify-between items-center m-2 px-6 mb-8">
              <button
                ...
                className="px-3 py-1 mr-4 rounded bg-gray-100 hover:bg-gray-200 disabled:opacity-50 transition-colors text-gray-700 dark:bg-[#262626] dark:hover:bg-[#404040] dark:text-white"
              >
                Previous
              </button>
              ...
              <button
                ...
                className="px-3 py-1 ml-2 rounded bg-gray-100 hover:bg-gray-200 disabled:opacity-50 transition-colors text-gray-700 dark:bg-[#262626] dark:hover:bg-[#404040] dark:text-white"
              >
                Next
              </button>
            </div>
