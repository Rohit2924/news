...
export default function Profile() {
        ...
        <div className="relative mb-8 overflow-hidden rounded-3xl bg-[#600000]/20 backdrop-blur-xl border border-white/30 shadow-2xl">
          ...
          <div className="relative p-8 text-center">
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-white/30 backdrop-blur-sm border border-white/40">
              <div className="h-5 w-5 rounded-full bg-amber-300/50 animate-pulse" />
              <div className="h-4 w-24 bg-white/50 rounded animate-pulse" />
            </div>
            <div className="h-12 w-48 bg-white/50 rounded-lg mx-auto mb-2 animate-pulse" />
            <div className="h-6 w-64 bg-white/50 rounded mx-auto animate-pulse" />
          </div>
        </div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8">
                  <div className="text-center mb-6">
                    <div className="h-6 w-32 bg-white/50 rounded mx-auto mb-2 animate-pulse" />
                    <div className="h-4 w-40 bg-white/50 rounded mx-auto animate-pulse" />
                  </div>

                  <div className="relative m-1 rounded-3xl bg-white/10 p-6">
                    <div className="relative mx-auto w-48 h-48 rounded-2xl bg-white/20 animate-pulse" />
                  </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-2 rounded-lg bg-white/20">
                      <div className="h-5 w-5 bg-white/50 rounded animate-pulse" />
                    </div>
                    <div className="h-6 w-48 bg-white/50 rounded animate-pulse" />
                  </div>
  ...
  // FIXED: Removed the unreachable return statement
                    ...
                    <label className="block">
                      ...
                      <div className="relative">
                        <input
                          ...
                          disabled={!isEditing || loading}
                          className="w-full px-4 py-4 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-200 bg-[#2A2A2A]/50 text-ivoryWhite backdrop-blur-sm font-medium"
                    ...
                    <label className="block">
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={handleInputChange}
                          disabled={!isEditing || loading}
                          className="w-full px-4 py-4 rounded-xl text-ivoryWhite border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-200 bg-[#2A2A2A]/50 backdrop-blur-sm font-medium"
                    ...
                    <label className="block">
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={handleInputChange}
                          disabled={!isEditing || loading}
                          className="w-full px-4 py-4 rounded-xl border-2 text-ivoryWhite border-gray-200 focus:border-pink-500 focus:ring-4 focus:ring-pink-100 transition-all duration-200 bg-[#2A2A2A]/50 backdrop-blur-sm font-medium"
